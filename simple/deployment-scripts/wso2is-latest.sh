...
|                         | this Agreement is:             |                                 |                                                                        |
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
| USA, Canada, any country| WSO2, LLC., a Delaware         | California without giving       | Arbitration in Santa Clara, California in accordance with the rules    |
...
function deploy(){
    ...
    echoBold "3. Follow \"https://is.docs.wso2.com/en/6.0.0/\" to start using WSO2 Identity Server.\n\n"
}
arg=$1
if [[ -z $arg ]]
then
